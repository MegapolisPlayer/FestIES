...
export const timezoneList: TimezoneType[] = [
	...
	makeTimezone(-8, ["San Francisco", "Vancouver", "Los Angeles"], ["Seattle", "San Diego", "Pitcairn Islands"]),
	makeTimezone(-7, ["Edmonton", "Albuquerque"], ["Denver", "Ciudad Juárez", "Phoenix"]),
	makeTimezone(-6, ["Manitoba", "Nashville", "Mexico City", "Chicago", "San Salvador"], ["Oklahoma City", "San Jose", "Kansas City", "Minneapolis", "Winnipeg", "Memphis", "Austin"]),
	makeTimezone(-5, ["Ottawa", "Bogotá", "Toronto", "Quito", "New York", "Washington D.C."], ["Cancún", "Pittsburgh", "Philadephia", "Kingston", "Montreal", "Havana"]),
	...
	makeTimezone(-3, ["Rio de Janeiro", "Buenos Aires", "São Paulo", "Santiago", "Montevideo"], ["Cordóba", "Stanley (Falklands)", "Porto Alegre", "Natal", "Cayenne"]),
	makeTimezone(-2, ["Nuuk"], []),
	makeTimezone(-1, ["Azores", "Cape Verde"], []),
	makeTimezone(0, ["Lisbon", "London", "Dublin"], ["Manchester", "Sheffield", "Liverpool", "Edinburgh", "Glasgow", "Bristol", "Birmingham", "Porto", "Monrovia"]),
	// :)
	makeTimezone(1, ["Weißwasser", "Tirana", "Wien", "Brussel", "Sarajevo", "Brazzaville", "Zagreb", "Praha", "København", "Paris", "Berlin", "Warszawa", "Budapest", "Roma", "Casablanca", "Amsterdam", "Lagos", "Skopje", "Oslo", "Beograd", "Bratislava", "Ljubljana", "Madrid", "Stockholm", "Zurich", "Bern"], ["Città del Vaticano", "Gothenburg", "Barcelona", "Seville", "Zaragoza", "Maribor", "Košice", "Niš", "Bergen", "Ústí nad Labem", "Rotterdam", "Den Haag", "Rabat", "Milano", "Napoli", "Pristina", "Vaduz", "Debrecen", "Antwerpen", "Graz", "Durrës", "Split", "Brno", "Aarhus", "Marseille", "Toulouse", "Nice", "Lyon", "Frankfurt am Main", "München", "Kraków", "Łódż", "Wrocław", "Katowice", "Gdańsk"]),
	makeTimezone(2, ["Kyiv", "Bucharest", "Talinn", "Riga", "Vilnius", "Kaunas", "Chisinau", "Jerusalem", "Sofia", "Helsinki", "Espoo", "Athens"], ["Thessaloniki", "Kaliningrad", "Nicosia", "Plovdiv", "Tartu", "Tel Aviv", "Gaza", "Tiraspol", "Iasi", "Dnipro", "Kharkiv", "Daugavpils"]),
	makeTimezone(3, ["Djibouti", "Baghdad", "Moscow", "Mecca", "Riyadh", "Medina", "Mogadishu", "Damascus"], ["Donetsk", "Luhansk", "Basra", "Kazan", "Nizhny Novgorod", "Aleppo", "Rostov-on-Don", "Dar es Salaam"]),
	makeTimezone(3.14, ["Π"], ["τ>π"]),
	makeTimezone(3.5, ["Tehran"], ["Mashhad"]),
	makeTimezone(4, ["Tbilisi", "Baku", "Dubai"], ["Yerevan", "Samara", "Tolyatti", "Abu Dhabi", "Muscat"]),
	makeTimezone(4.5, ["Kabul"], ["Kandahar", "Mazari Sharif"]),
	//2 hyderabads... India and Pakistan (they love each other)
	makeTimezone(5, ["Almaty", "Islamabad", "Tashkent"], ["Astana", "Faisalabad", "Hyderabad", "Chelyabinsk", "Yekaterinburg", "Namangan"]),
	//sri lanka colombo
	...
	makeTimezone(7, ["Jakarta", "Pakse", "Khovd", "Krasnoyarsk", "Novosibirsk", "Bangkok", "Ho Chi Minh City"], ["Surabaya", "Udon Thani", "Haiphong", "Hanoi", "Huế"]),
	makeTimezone(8, ["Beijing", "Taipei", "Shanghai", "Kuala Lumpur", "Ulanbataar", "Manila"], ["Irkutsk", "Perth", "Chongqing", "Dongguan", "Chengdu", "Nanjing", "Wuhan", "Tianjin", "Klang"]),
	makeTimezone(8.75, ["Eucla"], []),
	makeTimezone(9, ["Pyongyang", "Seoul", "Tokyo"], ["Chita", "Osaka", "Yakutsk", "Yokohama", "Hiroshima", "Nagasaki"]),
	makeTimezone(9.5, ["Darwin"], []),
	makeTimezone(10, ["Vladivostok", "Brisbane", "Port Moresby"], ["Khabarovsk", "Gold Coast", "Lae"]),
